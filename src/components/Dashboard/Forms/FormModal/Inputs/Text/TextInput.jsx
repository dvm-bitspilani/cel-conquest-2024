      ...
      <div className={styles.inputField}>
        {type !== "long" ? (
          <input
            ...
            className={
              error
                ? `${styles.input} ${styles[type]} ${styles.error}`
                : `${styles.input} ${styles[type]}`
            }
            placeholder={type === "link" ? "Enter a URL" : placeholder ?? ""}
          />
        ) : (
          <textarea
            id={name}
