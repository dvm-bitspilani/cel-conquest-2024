...
export default function SearchButton() {
    ...
    useEffect(() => {
        ...
        if (JSON.parse(localStorage.getItem("userData")).tokens) {
            axios
                .get(`https://conquest-api.bits-dvm.org/api/users/search/?query=${searchTerm}`, {
                    headers: {
                        ...
                        <div className={styles.searchResult}>
                            ...
                            {filteredResults.map((searchProfile) => (
                                ...
                                <div className={styles.show} key={searchProfile.id}>
                                    <img src={searchProfile.profile_logo} alt={searchProfile.name}></img>
                                    <div className={styles.details}>
                                        <div className={styles.companyName}>{searchProfile.company_name}</div>
                                        <div className={styles.name}>{searchProfile.name}</div>
                                        <div className={styles.desc}>{searchProfile.description}</div>
                                    </div>
                                </div>
