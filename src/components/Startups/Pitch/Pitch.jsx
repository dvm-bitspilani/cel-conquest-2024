                        ...
                        <div className={styles.button} onClick={togglePlay}>
                            ...
                            <div className={`${styles.pause}`}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" viewBox="0 0 46 46" fill="none">
                                    <path d="M23.39 44.7851C35.2034 44.7851 44.78 35.2073 44.78 23.3926C44.78 11.5778 35.2034 2 23.39 2C11.5766 2 2 11.5778 2 23.3926C2 35.2073 11.5766 44.7851 23.39 44.7851Z" fill="white" stroke="#FB723D" stroke-width="2.27027" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
